...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  SignoutInc = faSignOutAlt;
  public roomId!: string;
  public messageText!: string;
  public messageArray: { user: string, image: string, message: string }[] = [];
  private storageArray: { roomId: string; chats: { user: any; image: string, message: string; }[]; }[] = [];
  ...
  constructor(private modalService: NgbModal, private chatService: ChatService) {
    this.chatService.getMessage().subscribe((data: { user: string, image: string, message: string }) => {
